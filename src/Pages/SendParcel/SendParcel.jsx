...
const SendParcel = () => {
    const { register, handleSubmit, formState: { errors } } = useForm();
        ...
        const regionsDup1icate = serviceCenters.map(c => c.region);
const regions = [...new Set(regionsDup1icate)]; // <-- convert Set to array
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <form onSubmit={handleSubmit(handleSendParcel)} className='bg-white p-8 rounded-lg shadow-lg'>
                    ...
                    <div className="text-center mt-12">
                        <button 
                            type="submit" 
                            className="btn btn-primary btn-lg px-12 py-4 text-white text-xl font-bold"
                        >
                            Send Parcel
                        </button>
                    </div>
